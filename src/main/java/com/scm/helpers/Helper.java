...
public class Helper {
    ...
    public static String getLinkForEmailVerification(String emailToken) {
        ...
        String link = "https://smartcontactmanager-emlp.onrender.com/auth/verify-email?token=" + emailToken;
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    ...
                                    <tr>
                                        <td style="padding: 40px 30px;">
                                            <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 24px;">Welcome"""
